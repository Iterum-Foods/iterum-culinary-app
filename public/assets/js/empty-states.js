...
class EmptyStates {
  ...
  recipes() {
    return this.create({
      ...
      message:
        'Start creating your culinary masterpieces! Every great dish begins with an idea.',
      actions: [
        {
          label: 'Create Recipe',
          icon: '➕',
  ...
  ingredients() {
    return this.create({
      ...
      message:
        'Build your ingredient library to start creating recipes and managing inventory.',
      actions: [
        {
          label: 'Add Ingredient',
          icon: '➕',
          onClick:
            "document.querySelector('.add-ingredient-form')?.scrollIntoView({behavior: 'smooth'})",
          primary: true
        },
        {
  ...
  vendors() {
    return this.create({
      ...
      message:
        'Add your suppliers to track orders, compare prices, and manage relationships.',
      actions: [
        {
          label: 'Add Vendor',
          icon: '➕',
  ...
  equipment() {
    return this.create({
      ...
      message:
        'Keep track of your kitchen equipment, maintenance, and inventory.',
      actions: [
        {
          label: 'Add Equipment',
          icon: '➕',
...
window.showEmptyState = (element, type, options) =>
  window.emptyStates.show(element, type, options);
window.createEmptyState = options => window.emptyStates.create(options);

console.log(
  '✅ Empty State functions available: showEmptyState(), createEmptyState()'
);
