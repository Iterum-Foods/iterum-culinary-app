...
function getNotebookSidebarHTML(currentPage) {
  const pages = {
    ...
    'project-hub': {
      name: 'Projects',
      icon: 'fa-folder-tree',
      active: currentPage === 'project-hub'
    },
    'menu-builder': {
      name: 'Menu Builder',
      icon: 'fa-utensils',
    ...
    'recipe-library': {
      name: 'Recipe Index',
      icon: 'fa-book-open',
      active: currentPage === 'recipe-library'
    },
    ingredients: {
      name: 'Ingredients',
      icon: 'fa-carrot',
      active: currentPage === 'ingredients'
    },
    'recipe-developer': {
      name: 'Recipe Developer',
      icon: 'fa-flask',
      active: currentPage === 'recipe-developer'
    },
    calendar: {
      name: 'Calendar',
    ...
    'kitchen-management': {
      name: 'Kitchen',
      icon: 'fa-kitchen-set',
      active: currentPage === 'kitchen-management'
    },
    inventory: {
      name: 'Inventory',
    ...
    'vendor-management': {
      name: 'Vendors',
      icon: 'fa-store',
      active: currentPage === 'vendor-management'
    }
  };
  ...
  const tools = {
    'recipe-photo-studio': {
      name: 'Photo Studio',
      icon: 'fa-camera',
      active: currentPage === 'recipe-photo-studio'
    },
    'recipe-scaling-tool': {
      name: 'Recipe Scaling',
      icon: 'fa-calculator',
      active: currentPage === 'recipe-scaling-tool'
    }
  };
  ...
  Object.entries(pages).forEach(([pageId, page]) => {
    const activeClass = page.active
      ...
      : 'font-medium';
    const activeBg = page.active
      ? `style="background-color: var(--brand-primary-accent);"`
      : '';
    sidebarHTML += `
