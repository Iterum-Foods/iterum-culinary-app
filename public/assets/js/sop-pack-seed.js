    ...
    sops: [
      {
        ...
        jobTags: ['all'],
        body:
          'This demo restaurant includes ready-made how-to guides. Managers edit them in **SOP Hub** on the office app, then tap **Publish to Shift** so crew sees updates on the mobile **How-to** tab.\n\nUse this pack as a starting template for opening, kitchen, bar, FOH, and safety standards.'
      },
      {
        id: 'sop_opening_keys',
        categoryId: 'opening',
