        ...
        try {
            ...
            ingredients.forEach(ingredient => {
                ...
                if (ingredient.bestPrice) {
                    ...
                    // Calculate from case pricing if no vendor prices
                    const casePrice = ingredient.casePricing.pricePerCase;
                    const caseSize = ingredient.casePricing.caseSize || 1;
                    const conversionFactor = ingredient.casePricing.conversionFactor || 1.0;
                    
                    if (caseSize > 0 && conversionFactor > 0) {
                        price = casePrice / (caseSize * conversionFactor);
                        unit = ingredient.default_unit || ingredient.unit || 'lb';
                        vendor = ingredient.supplier || ingredient.preferred_vendor || 'Case Pricing';
                    }
                }
