...
(function (global) {
  ...
  var MEMBER_TO_UI_ROLE = {
    ...
    kitchen_manager: 'operations_gm',
    sous_chef: 'chef_leadership',
    employee_line: 'employee_line',
    front_of_house: 'employee_line',
    kitchen_staff: 'employee_line',
    prep_cook: 'employee_line',
    line_cook: 'employee_line',
    expeditor: 'employee_line',
    dishwasher: 'employee_line',
    bakery_pastry: 'employee_line',
    host: 'employee_line',
    server: 'employee_line',
    runner: 'employee_line',
    bartender: 'employee_line',
    bar_manager: 'operations_gm',
    support_staff: 'employee_line',
    inventory_clerk: 'purchasing',
